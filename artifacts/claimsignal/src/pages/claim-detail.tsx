      ...
      <div className="rounded-xl border border-border bg-card shadow-sm">
        ...
        <div className="grid gap-0 lg:grid-cols-[1.25fr_.75fr]">
           ...
           <div className="border-t border-border/80 bg-[#f8f5ed] p-5 sm:p-7 lg:border-l lg:border-t-0">
              <SectionLabel>AI interpretation</SectionLabel><p className="mt-1 text-[11px] text-muted-foreground">Structured assessment from mock_ai_analysis</p>{analysis ? <><div className="mt-4"><p className="text-[15px] leading-relaxed">{analysis.summary}</p></div>
